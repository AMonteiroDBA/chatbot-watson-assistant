 ...
 * Alk and the Watson Conversation service. When API calls are not needed, the
 * functions also do basic messaging between the client and the server.
 *
 * @summary   Functions for Alk Chat Bot.
 *
 */
        ...
        buildContextObject(req, function (err, params) {
                ...
                if (params.message) {
                    ...
                    assistant.message(params, function (err, data) {
                            ...
                            console.log("Got response from Alk: ", JSON.stringify(data));
